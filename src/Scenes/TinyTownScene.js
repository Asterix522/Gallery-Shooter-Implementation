class TinyTown extends Phaser.Scene {
    ...
    create() {
        ...
        this.moneyText = this.add.text(20, 60, '$0', {
            fontSize: '32px',
        ...
        this.livesText = this.add.text(10, -10, '♥ '.repeat(this.lives), {
            fontSize: '70px',
            fontFamily: 'Marker Felt',
            color: '#ff0000',
            padding: { x: 10, y: 5 }
        ...
        this.levelText= this.add.text(460, 10, 'Level: '+ this.level + '\nGoal: $' + this.goal, {
            fontSize: '32px',
            fontFamily: 'Marker Felt',
            color: '#ffffff',
            padding: { x: 10, y: 5 }
    ...
    spawnRoach() {
        ...
        const speed = this.roachSpeed; 
        const roach = new Roach(this, x, y, speed);
